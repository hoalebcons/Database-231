...
INSERT INTO Delivery (Name, Location)
VALUES
('Giao hàng Nhanh', 'Ho Chi Minh - District 1'),
('Chuyển phát Siêu Tốc', 'Ho Chi Minh - District 3'),
('Dịch vụ Giao hàng Tiết kiệm', 'Ho Chi Minh - District 5');
...
INSERT INTO Beverage (BeverageType)
VALUES
('Thức uống');
